...
class DataInitializer(val teacherRepository: TeacherRepository, val lackRepository: LackRepository) : ApplicationRunner {
    ...
    override fun run(args: ApplicationArguments) {
        ...
        if(teacherRepository.count()<= 0) {
            ...
            val lack0 = Lack(Article.PARTICULAR, LocalDate.of(2023, 12, 31),teacher2)
            val lack1 = Lack(Article.STUDYDAY,LocalDate.of(2023, 12, 30),teacher4)
            val lack2 = Lack(Article.STUDYDAY,LocalDate.of(2023, 12, 29),teacher4)
